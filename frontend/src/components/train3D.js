...
const Train3D = ({ motion }) => {
  ...
  const createHyperloopPod = () => {
    ...
    const bodyMaterial = new THREE.MeshPhongMaterial({ color: 0x1E90FF, shininess: 150, metalness: 0.8 });
    ...
    const noseMaterial = new THREE.MeshPhongMaterial({ color: 0x1E90FF, shininess: 150, metalness: 0.8 });
    ...
    const tailMaterial = new THREE.MeshPhongMaterial({ color: 0x1E90FF, shininess: 150, metalness: 0.8 });
    ...
    const windowMaterial = new THREE.MeshPhongMaterial({ color: 0x000000, transparent: true, opacity: 0.7 });
  ...
  const createEnvironment = (scene) => {
    ...
    const tubeMaterial = new THREE.MeshPhongMaterial({ color: 0x1b1f23, side: THREE.BackSide });
